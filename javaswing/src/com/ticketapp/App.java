...
public class App {
    ...
    private static void generateStaticAvatars() {
        ...
        String[][] members = {
            {"AF", "avatar1.png", "#1E293B", "#3B82F6"}, // Slate & Blue
            {"BS", "avatar2.png", "#111827", "#10B981"}, // Dark & Emerald
            {"CL", "avatar3.png", "#3F1B4F", "#D946EF"}, // Dark Purple & Fuchsia
            {"DN", "avatar4.png", "#1E1E2F", "#14B8A6"}  // Dark Gray & Teal
        };
